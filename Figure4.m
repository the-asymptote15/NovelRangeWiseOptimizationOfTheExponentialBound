...
%Aggarwal N = 3
erfcz1 = ( 1/(6) ) * ( (2 * ( exp(-( (1/((sin(1*(pi/2)/3))^2))).*(z.^2) ) + exp(-( (1/((sin(2*(pi/2)/3))^2))).*(z.^2)) ) + exp(-((z.^2))) )) ;
...
xlabel('x');
ylabel('RE');
axis([0 5 10^(-3) 10^(2)]); %axis scaling
...
semilogy(z,RE4,'b-o','linewidth',1);


%Aggarwal N = 4
z = linspace(0,5,points);

erfcz2 = ( 1/(8) ) * ( (2 * ( exp(-( (1/((sin(1*(pi/2)/4))^2))).*(z.^2) ) + exp(-( (1/((sin(2*(pi/2)/4))^2))).*(z.^2)) + exp(-( (1/((sin(3*(pi/2)/4))^2))).*(z.^2)) ) + exp(-((z.^2))) )) ;
RE2 = ((abs(erfc(z) - erfcz2)) ./ erfc(z)) * 100;
semilogy(z,RE2,'g-^','linewidth',1);


% % N = 5
% 
% erfcz3 = ( 1/(10) ) * ( (2 * ( exp(-( (1/((sin(1*(pi/2)/5))^2))).*(z.^2) ) + exp(-( (1/((sin(2*(pi/2)/5))^2))).*(z.^2)) + exp(-( (1/((sin(3*(pi/2)/5))^2))).*(z.^2)) + exp(-( (1/((sin(4*(pi/2)/5))^2))).*(z.^2)) ) + exp(-((z.^2))) )) ;
% RE3 = ((abs(erfc(z) - erfcz3)) ./ erfc(z)) * 100;
% semilogy(z,RE3,'c','linewidth',2);
...
semilogy(z,RE5,'r-*','linewidth',1);

%Legend of the plot:
h=legend('Ref. [22, N = 3] ','Optimized n=3','Ref. [22, N = 4] ','Optimized n=4');
